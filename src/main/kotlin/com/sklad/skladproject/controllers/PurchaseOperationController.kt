    ...
    fun addItemToStorage(@RequestBody purchaseOperation: PurchaseDto): AddingPurchaseResultDto {
        ...
        return purchase.fold(
            ...
            if (purchaseItem == null) {
                ...
                AddingPurchaseResultDto(acc.added, acc.failed + listOf(purchaseItemDto.describingString))
            } else {
                savePurchaseService.savePurchase(purchaseItem)

                AddingPurchaseResultDto(acc.added + listOf(purchaseItemDto.describingString), acc.failed)
            }
        }
    }
}
